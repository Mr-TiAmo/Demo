...
public class DateUtils {
     ...
     * 当前时间是否在两个时间之内
     */
    public static boolean getInTime(Time start, Time end) {
        if (start == null || end == null) {
            throw new IllegalArgumentException("getInTime param is null!");
        }
        try {
            Date now = new Date();
            SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd ");
            SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date startTime = sdf2.parse(sdf1.format(now) + start);
            Date endTime = sdf2.parse(sdf1.format(now) + end);
     ...
     * 获取两个Date的时差（时分）
     */
    public static String getHourMinute(Date begin, Date end) {
        if (begin == null || end == null) {
            throw new IllegalArgumentException("getHourMinute param is null!");
        }
        long time = end.getTime() - begin.getTime();
        long hour = time / 1000 / 60 / 60;
        long minute = (time - (hour * 60 * 60 * 1000)) / 1000 / 60;
        return hour + "." + minute;
    }
     ...
     * 获取两个Date的时差（时分秒）
     */
    public static String getHourMinuteSecond(Date begin, Date end) {
        if (begin == null || end == null) {
            throw new IllegalArgumentException("getHourMinute param is null!");
        }
        long time = end.getTime() - begin.getTime();
    ...
    public static int getDiffMinsByNull(Date beginDate, Date endDate) {
        int days = 0;
        if (beginDate == null) {
            long diff = (endDate.getTime()) / (1000 * 60);
            days = new Long(diff).intValue();
        }
        return days;
    }
    ...
    public static String dateShortTimeFormat(Date date) {
        SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
        String dateString = formatter.format(date);
        return dateString;
    }

    public static String dateShortMinuteFormat(Date date) {
    ...
    public static boolean beforeOrEqualDate(String date1, String date2) {
     ...
     * @throws ParseException
     */
    public static Date StringToShortDate(String str) throws ParseException {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
     ...
     * @return
     */
    public static Long betweenMs(Date beginDate, Date endDate) throws Throwable {
        if (beginDate == null || endDate == null) {
            throw new Throwable("时间不能空");
        }
...
//            } else {
    ...
    public static String formatTimeAddOne(Long ms) {
        Integer ss = 1000;
        Integer mi = ss * 60;
        Integer hh = mi * 60;
        Integer dd = hh * 24;
    ...
    public static long betweenHour(Date beginTime, Date endTime) {
        return DateUtil.between(beginTime, endTime, DateUnit.HOUR);
    }

    public static long betweenMinutes(Date beginTime, Date endTime) {
        return DateUtil.between(beginTime, endTime, DateUnit.MINUTE);
    }

    public static boolean betweenMinutes(Date beginTime, Date endTime,int minutes) {
        long ex = endTime.getTime() - beginTime.getTime();
        return ex <= minutes * 60 * 1000;
    }

    public static Date strToDateTime(String strDate) {
        return DateUtil.parse(strDate, DatePattern.NORM_DATETIME_FORMAT);
    }

    public static Date format(Date date, String format) {
        return DateUtil.parse(DateUtil.format(date, format), DatePattern.NORM_DATETIME_FORMAT);
    }
    ...
    public static boolean equals(String begin, String end) {
        DateTime beginDate = DateUtil.parseDateTime(begin);
        DateTime endDate = DateUtil.parseDateTime(end);
    ...
    public static String timeDifference(Date date1, Date date2) {
        return formatDateTime(date1.getTime() - date2.getTime());
    }
...
//        }
    ...
    public static boolean equalsDateTime(Date beginDate, Date endDate) {
        return beginDate.equals(endDate);
    }
    ...
    public static boolean beforeOrEqualDateTime(Date d1, Date d2) {
    ...
    public static boolean beforeOrEqualDateTime(String d1Str,String d2Str){

        boolean result = false;

        SimpleDateFormat formatter=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            Date d1 = formatter.parse(d1Str);
