package com.li.producer.config.database;
...
public class DruidDataSourceConfig {
    private static Logger logger = LoggerFactory.getLogger(com.li.producer.config.database.DruidDataSourceConfig.class);
